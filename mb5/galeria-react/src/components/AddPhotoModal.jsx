            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                        ...
                        <form>
                            <div className="row g-3">
                                <div className="col-md-6">
                                    ...
                                    <input type="text" className="form-control isinvalid" id="tytul" />
                                ...
                                <div className="col-md-6">
                                    ...
                                    <select className="form-select" id="kategoria"
                                        defaultValue="">
                                ...
                                <div className="col-12">
                                    ...
                                    <input type="file" className="form-control"
                                        id="plik" accept="image/*" />
                                    <div className="form-text">JPG lub PNG, maksymalnie
                                        5 MB.</div>
                                </div>
                                <div className="col-12">
                                    ...
                                    <textarea className="form-control" id="opis"
                                        rows="3"></textarea>
                    ...
                    <div className="modal-footer">
                        <button type="button" className="btn btn-secondary" databs-dismiss="modal">
                            Anuluj
                        </button>
